...
| SYSTEM-IMPLY-STEP-RELATIONSHIP | Không có trong V1 | DERIVATION | A và B là vợ chồng; A là cha/mẹ đẻ của C; B không đồng thời là cha/mẹ đẻ hoặc nuôi của C | `step-parent-of(B,C)` là derived fact | UI chỉ nhập quan hệ gốc; con chung có hai cạnh cha/mẹ đẻ nên không bị suy ra thành con riêng | MODEL-READY |
