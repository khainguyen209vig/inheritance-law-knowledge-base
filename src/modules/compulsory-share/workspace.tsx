...
export function CompulsoryShareWorkspace({ module, initialCase }: { module: AnalysisModuleDefinition; initialCase?: InitialCase }) {
  ...
  const facts = useMemo(() => [...buildFacts(drafts), ...buildCalculationFacts(calculations)], [drafts, calculations]);
...
function restoreCalculations(facts: ApiFact[], people: PersonDraft[], portions: PortionDraft[]): CalculationDraft[] {
