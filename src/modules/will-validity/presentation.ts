...
export function resultBadge(value: ModuleResultValue): "success" | "destructive" | "warning" | "secondary" {
  return { true: "success", false: "destructive", unknown: "warning", conflict: "secondary", statutory: "warning", testamentary: "success", excluded: "destructive", "not-excluded": "success", "exception-under-will": "warning", "rank-1": "success", "rank-2": "secondary", "rank-3": "warning" }[value] as
    | "success"
    | "destructive"
    | "warning"
    | "secondary";
