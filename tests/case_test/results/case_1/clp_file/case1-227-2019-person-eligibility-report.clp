...
; RESULT module=eligibility subject=ba-them article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-k article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-d article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-q article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-ty article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-p article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-l article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-chinh article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-t2 article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=be-t1 article-621-status=not-excluded rules=ELIGIBILITY-CLEAR
