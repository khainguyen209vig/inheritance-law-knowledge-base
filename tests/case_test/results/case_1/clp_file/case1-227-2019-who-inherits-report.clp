...
; RESULT module=inheritance-type subject=di-san-nha inheritance-regime=statutory rules=R-A01

; RESULT module=heir-rank subject=ba-them called-to-inherit=true rules=R-C06

; RESULT module=heir-rank subject=ba-k called-to-inherit=true rules=R-C06

; RESULT module=heir-rank subject=ba-d called-to-inherit=true rules=R-C06

; RESULT module=heir-rank subject=ong-q called-to-inherit=true rules=R-C06

; RESULT module=heir-rank subject=ong-chinh called-to-inherit=false rules=STATUTORY-CANDIDATE-INACTIVE

; RESULT module=heir-rank subject=ba-ty called-to-inherit=false rules=STATUTORY-CANDIDATE-INACTIVE

; RESULT module=heir-rank subject=ba-them candidate-heir-rank=rank-1 rules=R-C01

; RESULT module=heir-rank subject=ba-k candidate-heir-rank=rank-1 rules=R-C01

; RESULT module=heir-rank subject=ba-d candidate-heir-rank=rank-1 rules=R-C01

; RESULT module=heir-rank subject=ong-q candidate-heir-rank=rank-1 rules=R-C01

; RESULT module=heir-rank subject=ba-ty candidate-heir-rank=rank-1 rules=R-C01

; RESULT module=heir-rank subject=ong-chinh candidate-heir-rank=rank-1 rules=R-C01
