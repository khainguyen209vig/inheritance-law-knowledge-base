...
- Chế độ phân chia đối với Di san nha 384/99/16 Ly Thai To: chia theo pháp luật. _(rules: `R-A01`)_
- Việc được gọi hưởng đối với Ba Pham Thi Them (vo): Có. _(rules: `R-C06`)_
- Việc được gọi hưởng đối với Ba Tran Thi K (con): Có. _(rules: `R-C06`)_
- Việc được gọi hưởng đối với Ba Tran Thi D (con): Có. _(rules: `R-C06`)_
- Việc được gọi hưởng đối với Ong Tran Van Q (con - nguyen don): Có. _(rules: `R-C06`)_
- Việc được gọi hưởng đối với Ong Tran Q Chinh (con - chet): Không. _(rules: `STATUTORY-CANDIDATE-INACTIVE`)_
- Việc được gọi hưởng đối với Ba Tran Thi Ty (con - chet): Không. _(rules: `STATUTORY-CANDIDATE-INACTIVE`)_
- Hàng thừa kế đối với Ba Pham Thi Them (vo): hàng thứ nhất. _(rules: `R-C01`)_
- Hàng thừa kế đối với Ba Tran Thi K (con): hàng thứ nhất. _(rules: `R-C01`)_
- Hàng thừa kế đối với Ba Tran Thi D (con): hàng thứ nhất. _(rules: `R-C01`)_
- Hàng thừa kế đối với Ong Tran Van Q (con - nguyen don): hàng thứ nhất. _(rules: `R-C01`)_
- Hàng thừa kế đối với Ba Tran Thi Ty (con - chet): hàng thứ nhất. _(rules: `R-C01`)_
- Hàng thừa kế đối với Ong Tran Q Chinh (con - chet): hàng thứ nhất. _(rules: `R-C01`)_
- Quyền hưởng thế vị đối với Ba Tran Thi Kim L (chau the vi ba Ty): Có. _(rules: `R-E01`)_
- Quyền hưởng thế vị đối với Ba Hoang Thanh P (chau the vi ba Ty): Có. _(rules: `R-E01`)_
- Quyền hưởng thế vị đối với Tran Thanh T1 (chau the vi ong Chinh): Có. _(rules: `R-E01`)_
- Quyền hưởng thế vị đối với Tran D T2 (chau the vi ong Chinh): Có. _(rules: `R-E01`)_
...
8. **ELIGIBILITY-CLEAR** — Marker completeness cho biết các nhóm căn cứ Điều 621 đã được kiểm tra và không có căn cứ loại trừ nào được dẫn xuất.
   ...
   - Supports: `eligibility-candidate=true`, `eligibility-review-complete=true`
   - Source: `rules/03-eligibility.clp#ELIGIBILITY-CLEAR`
9. **ELIGIBILITY-CLEAR** — Marker completeness cho biết các nhóm căn cứ Điều 621 đã được kiểm tra và không có căn cứ loại trừ nào được dẫn xuất.
   - Kết luận: Không phát hiện căn cứ loại trừ trong phạm vi mô-đun
   - Supports: `eligibility-candidate=true`, `eligibility-review-complete=true`
   - Source: `rules/03-eligibility.clp#ELIGIBILITY-CLEAR`
...
8. **R-C06** — Chỉ sau khi danh sách ứng viên được xác nhận đầy đủ, hệ thống chọn hàng thấp nhất còn người sống, không từ chối hợp lệ và không bị loại khỏi thừa kế theo pháp luật.
   ...
   - Supports: `R-C06`, `STATUTORY-CANDIDATE-QUALIFIED`
   - Source: `rules/04-heir-rank.clp#R-C06-active-rank-one`, `rules/04-heir-rank.clp#R-C06-active-rank-two`, `rules/04-heir-rank.clp#R-C06-active-rank-three`, `rules/04-heir-rank.clp#R-C06-call-active-rank`
9. **STATUTORY-CANDIDATE-INACTIVE** — Ứng viên đã chết trước hoặc cùng thời điểm, từ chối hợp lệ, hoặc bị Điều 621 loại khỏi thừa kế theo pháp luật. Ngoại lệ được hưởng theo di chúc không làm người đó đủ điều kiện hưởng theo pháp luật.
...
10. **STATUTORY-CANDIDATE-INACTIVE** — Ứng viên đã chết trước hoặc cùng thời điểm, từ chối hợp lệ, hoặc bị Điều 621 loại khỏi thừa kế theo pháp luật. Ngoại lệ được hưởng theo di chúc không làm người đó đủ điều kiện hưởng theo pháp luật.
   - Kết luận: Ứng viên không được gọi hưởng theo pháp luật
   - Supports: `heir-life-status=dead-before-or-same`
   - Source: `rules/04-heir-rank.clp#STATUTORY-CANDIDATE-INACTIVE-ELIGIBILITY`, `rules/04-heir-rank.clp#STATUTORY-CANDIDATE-INACTIVE-LIFE`, `rules/04-heir-rank.clp#STATUTORY-CANDIDATE-INACTIVE-REFUSAL`
11. **R-C01** — Quan hệ vợ/chồng tại thời điểm mở thừa kế, cha mẹ đẻ hoặc nuôi, và con đẻ hoặc nuôi đặt người đang xét vào nhóm ứng viên hàng thứ nhất. Kết luận này chưa tự động có nghĩa người đó được gọi hưởng.
   - Kết luận: Ứng viên thuộc hàng thừa kế thứ nhất
   - Supports: `deceased-person=true`, `heir-rank-candidate=true`, `spouse-at-opening=ong-ngo`
...
12. **R-C01** — Quan hệ vợ/chồng tại thời điểm mở thừa kế, cha mẹ đẻ hoặc nuôi, và con đẻ hoặc nuôi đặt người đang xét vào nhóm ứng viên hàng thứ nhất. Kết luận này chưa tự động có nghĩa người đó được gọi hưởng.
   - Kết luận: Ứng viên thuộc hàng thừa kế thứ nhất
   - Supports: `deceased-person=true`, `heir-rank-candidate=true`, `biological-parent-of=ba-k`
   - Source: `rules/04-heir-rank.clp#R-C01-spouse`, `rules/04-heir-rank.clp#R-C01-spouse-reverse`, `rules/04-heir-rank.clp#R-C01-biological-parent`, `rules/04-heir-rank.clp#R-C01-adoptive-parent`, `rules/04-heir-rank.clp#R-C01-biological-child`, `rules/04-heir-rank.clp#R-C01-adoptive-child`
...
14. **R-C01** — Quan hệ vợ/chồng tại thời điểm mở thừa kế, cha mẹ đẻ hoặc nuôi, và con đẻ hoặc nuôi đặt người đang xét vào nhóm ứng viên hàng thứ nhất. Kết luận này chưa tự động có nghĩa người đó được gọi hưởng.
   - Kết luận: Ứng viên thuộc hàng thừa kế thứ nhất
   - Supports: `deceased-person=true`, `heir-rank-candidate=true`, `biological-parent-of=ong-q`
   - Source: `rules/04-heir-rank.clp#R-C01-spouse`, `rules/04-heir-rank.clp#R-C01-spouse-reverse`, `rules/04-heir-rank.clp#R-C01-biological-parent`, `rules/04-heir-rank.clp#R-C01-adoptive-parent`, `rules/04-heir-rank.clp#R-C01-biological-child`, `rules/04-heir-rank.clp#R-C01-adoptive-child`
15. **R-C01** — Quan hệ vợ/chồng tại thời điểm mở thừa kế, cha mẹ đẻ hoặc nuôi, và con đẻ hoặc nuôi đặt người đang xét vào nhóm ứng viên hàng thứ nhất. Kết luận này chưa tự động có nghĩa người đó được gọi hưởng.
   - Kết luận: Ứng viên thuộc hàng thừa kế thứ nhất
   - Supports: `deceased-person=true`, `heir-rank-candidate=true`, `biological-parent-of=ba-ty`
   - Source: `rules/04-heir-rank.clp#R-C01-spouse`, `rules/04-heir-rank.clp#R-C01-spouse-reverse`, `rules/04-heir-rank.clp#R-C01-biological-parent`, `rules/04-heir-rank.clp#R-C01-adoptive-parent`, `rules/04-heir-rank.clp#R-C01-biological-child`, `rules/04-heir-rank.clp#R-C01-adoptive-child`
16. **R-C01** — Quan hệ vợ/chồng tại thời điểm mở thừa kế, cha mẹ đẻ hoặc nuôi, và con đẻ hoặc nuôi đặt người đang xét vào nhóm ứng viên hàng thứ nhất. Kết luận này chưa tự động có nghĩa người đó được gọi hưởng.
   - Kết luận: Ứng viên thuộc hàng thừa kế thứ nhất
   - Supports: `deceased-person=true`, `heir-rank-candidate=true`, `biological-parent-of=ong-chinh`
   - Source: `rules/04-heir-rank.clp#R-C01-spouse`, `rules/04-heir-rank.clp#R-C01-spouse-reverse`, `rules/04-heir-rank.clp#R-C01-biological-parent`, `rules/04-heir-rank.clp#R-C01-adoptive-parent`, `rules/04-heir-rank.clp#R-C01-biological-child`, `rules/04-heir-rank.clp#R-C01-adoptive-child`
...
1. **REPRESENTED-CHILD-WOULD-BE-ENTITLED** — Người được thế vị là con ruột của người để lại di sản, chết trước hoặc cùng thời điểm và không bị loại theo Điều 621.
   ...
   - Supports: `deceased-person=true`, `biological-parent-of=ba-ty`, `heir-life-status=dead-before-or-same`, `ELIGIBILITY-CLEAR`
...
3. **R-E01** — Graph thể hiện người con của người để lại di sản đã chết trước hoặc cùng thời điểm, còn người con của họ đủ điều kiện hưởng phần thế vị.
   ...
   - Supports: `deceased-person=true`, `biological-parent-of=ba-ty`, `biological-parent-of=ba-l`, `REPRESENTED-CHILD-WOULD-BE-ENTITLED`, `REPRESENTATION-CANDIDATE-QUALIFIED`
...
5. **R-E01** — Graph thể hiện người con của người để lại di sản đã chết trước hoặc cùng thời điểm, còn người con của họ đủ điều kiện hưởng phần thế vị.
   - Kết luận: Cháu được xác định là người thừa kế thế vị
   - Supports: `deceased-person=true`, `biological-parent-of=ba-ty`, `biological-parent-of=ba-p`, `REPRESENTED-CHILD-WOULD-BE-ENTITLED`, `REPRESENTATION-CANDIDATE-QUALIFIED`
   - Source: `rules/05-representation.clp#R-E01-grandchild-represents-child`
6. **REPRESENTATION-CANDIDATE-QUALIFIED** — Ứng viên còn sống, không từ chối hợp lệ và không bị loại theo Điều 621.
   - Kết luận: Ứng viên đủ điều kiện để đối sánh đường thế vị
   - Supports: `representation-candidate=true`, `heir-life-status=alive`, `REFUSAL-STATUS-NORMALIZED`, `ELIGIBILITY-CLEAR`
   - Source: `rules/05-representation.clp#REPRESENTATION-CANDIDATE-QUALIFIED`
7. **R-E01** — Graph thể hiện người con của người để lại di sản đã chết trước hoặc cùng thời điểm, còn người con của họ đủ điều kiện hưởng phần thế vị.
   - Kết luận: Cháu được xác định là người thừa kế thế vị
   - Supports: `deceased-person=true`, `biological-parent-of=ong-chinh`, `biological-parent-of=be-t1`, `REPRESENTED-CHILD-WOULD-BE-ENTITLED`, `REPRESENTATION-CANDIDATE-QUALIFIED`
   - Source: `rules/05-representation.clp#R-E01-grandchild-represents-child`
8. **REPRESENTATION-CANDIDATE-QUALIFIED** — Ứng viên còn sống, không từ chối hợp lệ và không bị loại theo Điều 621.
   - Kết luận: Ứng viên đủ điều kiện để đối sánh đường thế vị
   - Supports: `representation-candidate=true`, `heir-life-status=alive`, `REFUSAL-STATUS-NORMALIZED`, `ELIGIBILITY-CLEAR`
   - Source: `rules/05-representation.clp#REPRESENTATION-CANDIDATE-QUALIFIED`
9. **R-E01** — Graph thể hiện người con của người để lại di sản đã chết trước hoặc cùng thời điểm, còn người con của họ đủ điều kiện hưởng phần thế vị.
   - Kết luận: Cháu được xác định là người thừa kế thế vị
   - Supports: `deceased-person=true`, `biological-parent-of=ong-chinh`, `biological-parent-of=ong-t2`, `REPRESENTED-CHILD-WOULD-BE-ENTITLED`, `REPRESENTATION-CANDIDATE-QUALIFIED`
   - Source: `rules/05-representation.clp#R-E01-grandchild-represents-child`
