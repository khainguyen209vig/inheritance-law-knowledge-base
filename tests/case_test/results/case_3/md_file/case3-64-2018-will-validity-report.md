...
- Chưa đủ căn cứ để kết luận valid will đối với Vu an 64/2018/DS-ST. _(rules: `SYSTEM-INCOMPLETE`)_
...
- `will-validity` · `case3-64-2018` · `will-type`: Cần bổ sung will type cho Vu an 64/2018/DS-ST.
- `will-validity` · `case3-64-2018` · `testator-mental-state`: Cần bổ sung testator mental state cho Vu an 64/2018/DS-ST.
- `will-validity` · `case3-64-2018` · `undue-influence`: Cần bổ sung undue influence cho Vu an 64/2018/DS-ST.
- `will-validity` · `case3-64-2018` · `prohibited-content`: Cần bổ sung prohibited content cho Vu an 64/2018/DS-ST.
