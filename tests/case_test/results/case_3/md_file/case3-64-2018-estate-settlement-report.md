...
- Phần dư chưa phân bổ (VNĐ) đối với Vu an 64/2018/DS-ST: 0. _(rules: `R-C04`)_
...
- Số người trong hàng được gọi hưởng đối với Vu an 64/2018/DS-ST: 5. _(rules: `ESTATE-VND-TOTALS`)_
- Di sản có thể phân chia (VNĐ) đối với Vu an 64/2018/DS-ST: 500000000. _(rules: `ESTATE-VND-TOTALS`)_
- Tổng nghĩa vụ (VNĐ) đối với Vu an 64/2018/DS-ST: 0. _(rules: `ESTATE-VND-TOTALS`)_
- Tổng di sản gộp (VNĐ) đối với Vu an 64/2018/DS-ST: 500000000. _(rules: `ESTATE-VND-TOTALS`)_
- Giá trị thuộc di sản (VNĐ) đối với Thua dat 281: 500000000. _(rules: `ESTATE-VND-ASSET`)_
...
6. **ESTATE-VND-ASSET** — Từ giá trị định giá bằng VNĐ và tỷ lệ sở hữu đã được xác nhận, hệ thống tính phần giá trị thuộc di sản bằng phép chia số nguyên. Phần nhỏ hơn một VNĐ được ghi riêng và không tự phân bổ.
   ...
   - Supports: `estate-asset=true`, `asset-value-vnd=500000000`, `deceased-ownership-numerator=1`, `deceased-ownership-denominator=1`
