...
; RESULT module=eligibility subject=ba-ng article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-m article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-m1 article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ba-b article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-x article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-v article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-s article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ngo-b article-621-status=not-excluded rules=ELIGIBILITY-CLEAR

; RESULT module=eligibility subject=ong-h1 article-621-status=not-excluded rules=ELIGIBILITY-CLEAR
