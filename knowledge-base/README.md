...
Mô-đun `representation` triển khai R-E01/R-E02 theo Điều 652, R-E03a/R-E03b theo Điều 653 và R-E04/R-E05 theo Điều 654. CLIPS suy ra `would-be-entitled-if-alive` rồi đối sánh nhánh cháu/chắt; quan hệ con nuôi được giữ tách biệt với quan hệ cha mẹ đẻ. `SYSTEM-IMPLY-STEP-RELATIONSHIP` suy ra bố/mẹ kế từ hai facts gốc vợ/chồng và cha/mẹ đẻ; không suy ra quan hệ kế khi người vợ/chồng còn lại đã là cha/mẹ đẻ hoặc cha/mẹ nuôi của cùng người con. Trên graph editor, con chung được biểu diễn bằng hai facts cùng loại: hai cạnh cha/mẹ đẻ hoặc hai cạnh cha/mẹ nuôi. Hợp đồng `step-parent-of` asserted và `step-care-status(edge-id,...)` chỉ được giữ để tương thích các hồ sơ/fixtures cũ trong lúc chuyển presenter Điều 654 sang đánh giá quan hệ dẫn xuất. R-E03–R-E05 không tự kết luận quyền hưởng cuối cùng; R-E01/R-E02/R-E04/R-E05 vẫn là `TEAM_REVIEW`.
...
Mô-đun `limitation` triển khai R-J01–R-J07 theo Điều 623. CLIPS phân loại yêu cầu và dẫn xuất `limitation-period-years`; TypeScript temporal helper cộng năm lịch vào `inheritance-opening-date` để tạo `limitation-deadline`. R-J05–R-J07 chỉ chạy khi việc hết thời hiệu đã được xác nhận bên ngoài phép cộng ngày. Hai lớp completeness kiểm soát việc xác nhận không có người thừa kế quản lý và không có người chiếm hữu đủ Điều 236 trước khi chuyển nhánh; hệ thống không tự đánh giá Điều 236. R-J05/R-J06 giữ `TEAM_REVIEW`.
