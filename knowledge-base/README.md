...
Mô-đun `estate-settlement` triển khai R-I01–R-I03 theo Điều 658–660. Bảng ưu tiên là knowledge facts; nhóm chia theo di chúc có danh sách beneficiary và completeness riêng. R-I03 không nhập kết luận “cùng hàng”: driver nạp C/D/H trong cùng working memory, lấy `candidate-heir-rank` từ graph và so với `active-heir-rank`, còn UI chỉ ghi nhận trạng thái thai và kết quả sinh. R-I03b giữ `TEAM_REVIEW`. Hệ thống chưa phân bổ tài sản hoặc tính phần end-to-end.
